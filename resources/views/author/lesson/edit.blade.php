                ...
                <div
                    ...
                    <div class="flex-auto px-4 lg:px-10 py-10 pt-0 bg-gray-100">
                        ...
                        <form action="/author/lesson-update" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="relative mt-6">
                                <label for="message"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Descripción del Capítulo</label>
                            ...
                            <div class="relative mt-6">
                                <label for="floating_outlined"
                                    ...
                                    <div data-popover id="popover-default" role="tooltip"
                                        ...
                                        <div class="px-3 py-2">
                                            <p>Para obtener el ID de un video de YouTube, observa la URL del video de YouTube y busca la parte que comienza después de 'v=' en la URL. Por ejemplo, si la URL de tu video de YouTube es 'https://www.youtube.com/watch?v=AbCdEfGhIjK', entonces el ID del video es 'AbCdEfGhIjK'.</p>
                                        </div>
                            ...
                            <div class="w-full flex justify-end">
                                <button type="submit"
                                    class="self-end w-32 mt-10 focus:outline-none text-white border border-primary bg-primary hover:bg-neutral-800 focus:ring-4 focus:ring-neutral-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-neutral-700 dark:hover:bg-slate-700 dark:focus:ring-slate-800">enviar</button>
                            </div>
                        </form>
                    </div>
                </div>
