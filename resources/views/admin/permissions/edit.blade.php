    ...
    <div class="relative md:ml-72 bg-blueGray-50">
        ...
        <div class="px-4 md:px-10 mx-auto w-full -m-36 min-h-screen">
            <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-white mx-auto">
                <div class="p-5">
                    <h2 class="text-xl mb-2">Editar Permisos</h2>
                    <form class="" method="POST" action="{{ route('permissions.update', $permission) }}">
                        ...
                        <div class="relative z-0 w-full mb-6 group p-2">
                            ...
                            <label for="floating_email"
                                class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Permisos </label>
                            @error('name')
